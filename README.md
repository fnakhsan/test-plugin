...
![Build](https://github.com/fnakhsan/test-plugin/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/fnakhsan/test-plugin/releases/latest) and install it manually using
